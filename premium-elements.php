<?php 
/* Template Name: MoveAddons Premium Elements */
        ...
        <div class="row">
            ...
            <div class="col-12">
                <div class="htmove-page-header-content htmove-page-header-content-pro">
                    <span class="icon"><img src="<?php echo get_stylesheet_directory_uri() ?>/assets/images/page-header/icon-pro.png" alt="Move Addons WP plugin for Elementor Page builder"></span>
    ...
    <div class="inner section section-padding" data-bg-image="<?php echo get_stylesheet_directory_uri() ?>/assets/images/cta/bg.jpg">
        <div class="container">
            <div class="htmove-footer-cta-content">
                ...
                <div class="icon"><img src="<?php echo get_stylesheet_directory_uri() ?>/assets/images/cta/icon.png" alt="Move addons is a WordPress plugin for Elementor"></div>
